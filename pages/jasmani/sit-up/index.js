...
export default function SitUpTest() {
  ...
  const calculateScore = async (e) => {
    ...
    if (gender === "Pria") {
      calculatedScore = Math.min(100, Math.max(0, Math.round(((r - 10) / (40 - 10)) * 100)));
    } else {
      calculatedScore = Math.min(100, Math.max(0, Math.round(((r - 8) / (40 - 8)) * 100)));
    }
  ...
  return (
    <>
      <Head>
        <title>Kalkulator Sit Up - BelajarMengabdi</title>
      </Head>
        ...
        <div className="card-frame">
          <div>
            <div className="top-bar-nav">
              ...
              <h2 className="screen-title" style={{ fontSize: "14px" }}>SIT UP (1 MENIT)</h2>
              <div style={{ width: "38px" }}></div>
            </div>

            <div className="header-brand" style={{ marginBottom: "20px" }}>
              <h1 className="brand-title" style={{ fontSize: "20px" }}>Sit Up</h1>
              <p className="brand-subtitle" style={{ fontSize: "12px" }}>Uji Kekuatan Otot Perut</p>
            </div>
            ...
            <div className="question-box" style={{ minHeight: "auto", fontSize: "12px", lineHeight: "1.4", marginBottom: "20px", color: "var(--color-text-white)" }}>
              ...
              <p style={{ marginBottom: "2px" }}>• Pria: 40 Kali (0 Nilai: ≤ 10 kali)</p>
              <p style={{ marginBottom: "2px" }}>• Wanita: 40 Kali (0 Nilai: ≤ 8 kali)</p>
            </div>
