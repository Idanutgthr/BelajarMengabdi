...
export default function PengetahuanUmum() {
  ...
  if (!isLoaded || questions.length === 0) {
    return (
      <>
        <Head>
          <title>Pengetahuan Umum - BelajarMengabdi</title>
        </Head>
        ...
        <div className="card-frame">
          <div>
            <div className="top-bar-nav">
              ...
              <h2 className="screen-title" style={{ fontSize: "14px" }}>PENGETAHUAN UMUM</h2>
              {!isSubmitted ? (
                <div style={{
