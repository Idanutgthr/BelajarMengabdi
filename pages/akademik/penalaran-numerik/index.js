...
export default function PenalaranNumerik() {
  ...
  return (
    <>
      <Head>
        <title>Penalaran Numerik - BelajarMengabdi</title>
      </Head>
        ...
        <div className="card-frame">
          <div>
            <div className="top-bar-nav">
              ...
              <h2 className="screen-title" style={{ fontSize: "14px" }}>PENALARAN NUMERIK</h2>
