...
export default function BahasaIndonesia() {
  ...
  return (
    <>
      <Head>
        <title>Bahasa Indonesia - BelajarMengabdi</title>
      </Head>
        ...
        <div className="card-frame">
          <div>
            <div className="top-bar-nav">
              ...
              <h2 className="screen-title" style={{ fontSize: "14px" }}>BAHASA INDONESIA</h2>
            ...
            <div className="content-scroll-area">
              {!isSubmitted ? (
                <>
                  ...
                  <div className="question-box" style={{ whiteSpace: "pre-line" }}>
                    <p>{q.question}</p>
                  </div>
